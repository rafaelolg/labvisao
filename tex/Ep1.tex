...
A seguir, o resultado obtido pelo novo método, utilizando parâmetros de localidade e auto-nivelamento.
...
Foi realizada uma entrevista na qual cada um teve que eleger, em ordem crescente, as dez imagens do banco de imagens que eles achavam mais parecidas na opinião de cada um. Com isso, tem-se uma referência que servirá como referência para os algoritmos implementados. O resultado da pesquisa pode ser visto a seguir:
